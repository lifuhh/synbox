	...
	"items": [
		{
			...
			"snippet": {
				...
				"description": "配信限定 2nd album「Clumsy」収録曲 「ラブレター feat. 春茶」LISTEN & DL →https://linkco.re/prxtScat この動画は皆さんから ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"description": "配信限定 2nd album「Clumsy」収録曲 配信サイト一覧→https://linkco.re/prxtScat 春に揺られど君想う feat. こぴ / KOBASOLO 作詞 ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "大切なもの/ロードオブメジャー(By コバソロ &amp; けんいち(元ロードオブメジャー) &amp; えみい(テーマパークガール))",
				"description": "今回はロードオブメジャーの大切なものをご本人様とデュエットカバーしました。今回のボーカルはけんいちさんとえみい(テーマ ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "【女性が歌う】小さな恋のうた/MONGOL800(Full Covered by コバソロ &amp; 杏沙子)歌詞付き",
				"description": "今回はMONGOL800の小さな恋のうたをフルカバーしました。Voをしてくれたのはシンガーソングライターの杏沙子さん。",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"description": "今回はbacknumberのヒロインをカバーしました。今回Voをしてくれたのはシンガーソングライターの杏沙子さん。チャンネル ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "【ドラゴンボールGT】DAN DAN 心魅かれてく/FIELD OF VIEW(Covered by コバソロ &amp; 未来)",
				"description": "今回はドラゴンボールGTのopのFIELD OF VIEW /DAN DAN 心魅かれてく(作詞 ZARD/坂井泉水)をカバーしました。今回の ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "【女性が歌う】Vaundy / 怪獣の花唄(Covered by コバソロ &amp; かんのじゅリ。)",
				"description": "今回はVaundyさんの怪獣の花唄をカバーしました。今回のボーカルはかんのじゅリ。さん！チャンネル登録してね！",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "【女性が歌う】まちがいさがし / 菅田将暉(Covered by コバソロ &amp; 相沢)",
				"description": "今回はパーフェクトワールド主題歌で米津玄師さん楽曲提供の菅田将暉さんの まちがいさがし をカバーしました。今回のボーカル ...",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "命に嫌われている。/ カンザキイオリ(Covered by コバソロ &amp; 相沢)",
				"description": "今回はカンザキイオリさんの命に嫌われているをカバーしました。今回のボーカルは相沢さん！MV主演は五味未知子さん！",
				"thumbnails": {
					"default": {
		...
		},
		{
			...
			"snippet": {
				...
				"channelId": "UCDbQblY1XASbgqOXmy6FOFQ",
				"title": "宇多田ヒカル / First Love(Covered by コバソロ &amp; YUJEONG &amp; SOYEON from LABOUM)",
				"description": "今回は宇多田ヒカルさんのFirst Loveをカバーしました。今回のボーカルはLABOUMのYUJEONGさんとSOYEONさん！",
				"thumbnails": {
					"default": {
